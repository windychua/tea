...
class Mdl_produk extends CI_Model {
	...
	var $column_order = array('id_produk','produk_utama','produk_gambar',null); //set column field database for datatable orderable
	var $column_search = array('id_produk','produk_utama','produk_gambar'); //set column field database for datatable searchable just title , author , category are searchable
	var $order = array('id_produk' => 'asc'); // default order
	
	var $table2 = 'tb_produk';
	var $column_orderid = array('id_detail','detail_judul','detail_deskripsi','detail_gambar',null); //set column field database for datatable orderable
	var $column_searchid = array('id_detail','detail_judul','detail_deskripsi','detail_gambar');
