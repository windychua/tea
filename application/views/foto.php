	...
	<section class="section-padding" id="health">
		<div class="container">
			<div class="row">
				...
				<div class="col-md-6">
					<div class="health-bg">
						<img src="<?= base_url().'assets/' ?>img/helth-tea.jpg" alt="healthy photo">
					</div>
				</div>
			</div>
		</div>
				...
				<div class="col-sm-6">
					<div class="testimonial-slides">
						...
						<div class="testimonial-single-item">
							<div class="clint">
								<img src="<?= base_url().'assets/' ?>img/testimonial/1.jpg" alt="clint">
...
<!--
						<div class="testimonial-single-item">
							<div class="clint">
								<img src="<?= base_url().'assets/' ?>img/testimonial/2.jpg" alt="clint">
								<div class="clint-name">
									<h4>Johny john <span>Usa Client</span></h4>
									<div class="clint-ratting">
										<i class="fa fa-star"></i>
...
<!--
						<div class="testimonial-single-item">
							<div class="clint">
								<img src="<?= base_url().'assets/' ?>img/testimonial/3.jpg" alt="clint">
								<div class="clint-name">
									<h4>Johny john <span>Usa Client</span></h4>
									<div class="clint-ratting">
										<i class="fa fa-star"></i>
...
<!--
						<div class="testimonial-single-item">
							<div class="clint">
								<img src="<?= base_url().'assets/' ?>img/testimonial/4.jpg" alt="clint">
								<div class="clint-name">
									<h4>Johny john <span>Usa Client</span></h4>
									<div class="clint-ratting">
										<i class="fa fa-star"></i>
...
<!--
				...
				<div class="col-sm-6">
					<div class="testimonial-photo">
						<img src="<?= base_url().'assets/' ?>img/testimonial/testimonial-bg.jpg" alt="testimonial-bg">
					</div>
				</div>
			</div>
		</div>
