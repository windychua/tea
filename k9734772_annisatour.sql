...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 09, 2018 at 11:05 AM
...
(1, 'annisa.png', '<p>Tentang Biro Perjalanan Annisa Tour</p>', 1, 'Annisa Tour', '<p>Tentang Biro Perjalanan Annisa Tour</p>', 'Annisa Tour');
...
(25, 'Bali', 'bali.jpg', 1, 6, 'Bali', '<p>Bali</p>', 'Bali'),
...
(29, 'Pulau Sempu', 'pakettoursempu2.jpg', 1, 6, 'Pulau Sempu', '<p>Pulau Sempu adalah suatu pantai yang terletak pada Kabupaten Malang. Untuk ke pulau sempu harus menaiki perahu terlebih dahulu karena terletak di tengah dari beberapa lautan</p>', 'Malang, Pantai, Sempu,'),
(30, 'Malang', 'malang2.jpg', 1, 7, 'Malang', '<p>Balai Kota malang adalah tempat dimana kita dapat menikmati indahnya malam hari dengan lampu - lampu yang unik.</p>', 'Malang, Balai Kota, Taman');
...
(9, 'PAKET TOUR MATARAM', '<h4>Detail PAKET TOUR MATARAM</h4>\n<p><span>Hari Pertama :&nbsp;</span><br /><span>* Dari Bandara Anda dijemput crew Annisa Tour lalu menuju Rest.Lokal untuk makan siang selanjutnya rekreasi city tour Mataram ke Senggigi.</span></p>\n<p><span><span>Harga</span><br /><span class=\"harga\">Rp. 1.500.000</span></span></p>', 'mataram.jpg', 1, '8', 'Paket Tour Mataram', '<p><span>Hari Pertama :&nbsp;</span><br /><span>* Dari Bandara Anda dijemput crew Annisa Tour lalu menuju Rest.Lokal untuk makan siang selanjutnya rekreasi city tour Mataram ke Senggigi.</span></p>', 'Paket Tour Mataram'),
...
(1, 'Annisa Tour', '<p>Paket Wisata Annisa TourMalang</p>', '1 (26)-min.jpg', 1),
(3, 'Lorem ipsum dolor sit amet', 'Duis autem vel eum iriure dolor in hendrerit in vulputate velit esse molestie consequat, vel illum dolore eu feugiat nulla facilisis at vero eros et accumsan et iusto odio dignissim qui blandit.', 'sempu.jpg', 1),
(4, 'Lorem ipsum dolor sit amet', 'Duis autem vel eum iriure dolor in hendrerit in vulputate velit esse molestie consequat, vel illum dolore eu feugiat nulla facilisis at vero eros et accumsan et iusto odio dignissim qui blandit.', '1 (8)-min.JPG', 1);
